...
Odoo ERP system. \
The [OdooClient](/java-odoo-xml-rpc-core/src/main/java/ch/helvethink/odoo4java/xmlrpc/OdooClient.java) class helps to serialize Odoo's responses into Java objects.
